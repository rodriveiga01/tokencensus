...
- Floating live counter: while live, the menu-bar card offers a pop-out button that floats a thin always-on-top pill (red dot + today's tokens, ticking every second, width hugging the number, draggable). When activity goes quiet it fades + drifts away on its own; clicking the button again dismisses it early.
