...
- Floating live counter: while live, the menu-bar card offers a pop-out button that floats a small always-on-top pill (today's tokens, ticking every second, draggable). When activity goes quiet it fades + drifts away on its own; clicking the button again dismisses it early.
